  ...
  return (
    <div>
      ...
      <ConfirmDialog
        ...
        title={deleteOriginalFiles ? 'Delete Files From Disk' : 'Remove From Nazr'}
        message={
          deleteOriginalFiles
            ? `Permanently delete ${selectedIds.size} ${selectedIds.size === 1 ? 'file' : 'files'} from Nazr and from disk? This cannot be undone.`
            : `Remove ${selectedIds.size} ${selectedIds.size === 1 ? 'item' : 'items'} from the Nazr index? The original files will remain on disk.`
        }
        confirmText="Delete"
        cancelText="Cancel"
        variant="danger"
