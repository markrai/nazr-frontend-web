  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        message={
          deleteOriginalFiles
            ? `This will delete "${assetToDelete?.filename ?? 'this asset'}" from Nazr and remove the original file from disk. This cannot be undone.`
            : `Remove "${assetToDelete?.filename ?? 'this asset'}" from the Nazr index? The original file stays on disk.`
        }
        confirmText="Delete"
        cancelText="Cancel"
        variant="danger"
